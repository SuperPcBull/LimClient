...
template <> struct is_proto_enum< ::GetUserInfo::QotRight> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::GetUserInfo::QotRight>() {
  return ::GetUserInfo::QotRight_descriptor();
}
