...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      ...
      "\006userID\030\001 \002(\004\"\206\002\n\003S2C\022\020\n\010marketHK\030\001 \002(\005\022"
      ...
      "ramStatus\030\014 \001(\0132\025.Common.ProgramStatus\"+"
      "\n\007Request\022 \n\003c2s\030\001 \002(\0132\023.GetGlobalState."
      "C2S\"d\n\010Response\022\025\n\007retType\030\001 \002(\005:\004-400\022\016"
      "\n\006retMsg\030\002 \001(\t\022\017\n\007errCode\030\003 \001(\005\022 \n\003s2c\030\004"
      " \001(\0132\023.GetGlobalState.S2C"
  };
...
// @@protoc_insertion_point(message_clear_start:GetGlobalState.S2C)
  ...
  if (cached_has_bits & 254u) {
    ::memset(&markethk_, 0, static_cast<size_t>(
        ...
        reinterpret_cast<char*>(&markethk_)) + sizeof(trdlogined_));
  }
  if (cached_has_bits & 3840u) {
    ::memset(&serverver_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&localtime_) -
        reinterpret_cast<char*>(&serverver_)) + sizeof(localtime_));
  }
  _has_bits_.Clear();
  _internal_metadata_.Clear();
}
